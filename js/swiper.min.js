...
!(function (e, t) {
  ...
  var h = {
    ...
    updateSlidesClasses: function () {
      ...
      t.removeClass(
        ...
        (e = n
          ? this.$wrapperEl.find(
              "." + i.slideClass + '[data-popup__item-index="' + a + '"]'
            )
    ...
    updateActiveIndex: function (e) {
      ...
      if ((t >= a.length && (t = a.length - 1), h !== o)) {
        var u = parseInt(
          this.slides.eq(h).attr("data-popup__item-index") || h,
          10
        );
        n.extend(this, {
          snapIndex: t,
      ...
      (this.clickedSlide = i),
        this.virtual && this.params.virtual.enabled
          ? (this.clickedIndex = parseInt(
              s(i).attr("data-popup__item-index"),
              10
            ))
  ...
  var u = {
    ...
    slideToClickedSlide: function () {
      ...
      if (i.loop) {
        ...
        (e = parseInt(s(t.clickedSlide).attr("data-popup__item-index"), 10)),
          i.centeredSlides
  ...
  var v = {
    loopCreate: function () {
      ...
      r.each(function (e, i) {
        ...
        e < t.loopedSlides && h.push(i),
          ...
          a.attr("data-popup__item-index", e);
      });
    ...
    loopDestroy: function () {
      ...
      e
        ...
        .remove(),
        i.removeAttr("data-popup__item-index");
    },
  };
  var f = {
  ...
  var V = {
      ...
      passiveListeners: !0,
      containerModifierClass: "popup__swiper-container-",
      slideClass: "popup__item",
      slideBlankClass: "popup__item-invisible-blank",
      slideActiveClass: "popup__item-active",
      slideDuplicateActiveClass: "popup__item-duplicate-active",
      slideVisibleClass: "popup__item-visible",
      slideDuplicateClass: "popup__item-duplicate",
      slideNextClass: "popup__item-next",
      slideDuplicateNextClass: "popup__item-duplicate-next",
      slidePrevClass: "popup__item-prev",
      slideDuplicatePrevClass: "popup__item-duplicate-prev",
              ...
              t &&
                ...
                o &&
                  ...
                  o
                    ...
                    .removeAttr("style")
                    .removeAttr("data-popup__item-index")),
              i.emit("destroy"),
    ...
    Q = {
      update: function (e) {
        ...
        M.forEach(function (e) {
          ...
          t.$wrapperEl.children(".popup__item").css(g, E + "px"),
          S();
      },
      renderSlide: function (e, t) {
        ...
        return (
          a.attr("data-popup__item-index") ||
            a.attr("data-popup__item-index", t),
      ...
      prependSlide: function (e) {
        ...
        if (this.params.virtual.cache) {
          ...
          Object.keys(r).forEach(function (e) {
            var t = r[e],
              i = t.attr("data-popup__item-index");
            i && t.attr("data-popup__item-index", parseInt(i, 10) + 1),
              (n[parseInt(e, 10) + s] = t);
          }),
                ...
                i.loadImage(o[0], d || l, h, p, !1, function () {
                  if (null != i && i && (!i || i.params) && !i.destroyed) {
                    if (
                      ...
                      var e = r.attr("data-popup__item-index");
      ...
      load: function () {
        ...
        function d(e) {
          if (n) {
            if (
              t.children(
                "." + i.slideClass + '[data-popup__item-index="' + e + '"]'
              ).length
            )
              return !0;
        ...
        function h(e) {
          return n ? s(e).attr("data-popup__item-index") : s(e).index();
        }
        if (
          ("auto" === l && (l = 0),
          ...
          t.children("." + i.slideVisibleClass).each(function (t, i) {
            var a = n ? s(i).attr("data-popup__item-index") : s(i).index();
    ...
    fe = {
      setTranslate: function () {
        ...
        for (var u = 0; u < a.length; u += 1) {
          var v = a.eq(u),
            f = u;
          p && (f = parseInt(v.attr("data-popup__item-index"), 10));
          var m = 90 * f,
            g = Math.floor(m / 360);
          ...
          if (
            ...
            var E = h
                ? v.find(".popup__item-shadow-left")
                : v.find(".popup__item-shadow-top"),
              S = h
                ? v.find(".popup__item-shadow-right")
                : v.find(".popup__item-shadow-bottom");
            0 === E.length &&
              ((E = s(
                '<div class="popup__item-shadow-' +
                  (h ? "left" : "top") +
                  '"></div>'
              )),
              v.append(E)),
      ...
      setTransition: function (e) {
        ...
        this.slides
          .transition(e)
          .find(
            ".popup__item-shadow-top, .popup__item-shadow-right, .popup__item-shadow-bottom, .popup__item-shadow-left"
          )
          .transition(e),
        ...
        for (
          ...
          if (
            ...
            var h = this.isHorizontal()
                ? a.find(".popup__item-shadow-left")
                : a.find(".popup__item-shadow-top"),
              p = this.isHorizontal()
                ? a.find(".popup__item-shadow-right")
                : a.find(".popup__item-shadow-bottom");
            0 === h.length &&
              ((h = s(
                '<div class="popup__item-shadow-' +
                  (this.isHorizontal() ? "left" : "top") +
      ...
      setTranslate: function () {
        for (
          ...
          if (
            ...
            var C = l
                ? f.find(".popup__item-shadow-left")
                : f.find(".popup__item-shadow-top"),
              M = l
                ? f.find(".popup__item-shadow-right")
                : f.find(".popup__item-shadow-bottom");
            0 === C.length &&
              ((C = s(
                '<div class="popup__item-shadow-' +
                  (l ? "left" : "top") +
      ...
      onThumbClick: function () {
        ...
        if (e) {
          ...
          if (
            ...
            if (
              ((a = e.params.loop
                ? parseInt(s(e.clickedSlide).attr("data-popup__item-index"), 10)
                : t),
              this.params.loop)
            ) {
              ...
              var n = this.slides
                  .eq(r)
                  .prevAll('[data-popup__item-index="' + a + '"]')
                  .eq(0)
                  .index(),
                o = this.slides
                  .eq(r)
                  .nextAll('[data-popup__item-index="' + a + '"]')
                  .eq(0)
                  .index();
        ...
        if (t) {
          ...
          if (this.realIndex !== t.realIndex) {
            ...
            if (t.params.loop) {
              ...
              var r = t.slides
                  .eq(a)
                  .prevAll('[data-popup__item-index="' + this.realIndex + '"]')
                  .eq(0)
                  .index(),
                n = t.slides
                  .eq(a)
                  .nextAll('[data-popup__item-index="' + this.realIndex + '"]')
                  .eq(0)
                  .index();
              s =
                void 0 === r
          ...
          if (
            ...
            for (var d = 0; d < o; d += 1)
              t.$wrapperEl
                .children(
                  '[data-popup__item-index="' + (this.realIndex + d) + '"]'
                )
                .addClass(l);
          else
            for (var h = 0; h < o; h += 1)
      ...
      },
      {
        ...
        params: {
          pagination: {
            ...
            bulletClass: "popup__swiper-pagination-bullet",
            bulletActiveClass: "popup__swiper-pagination-bullet-active",
            modifierClass: "popup__swiper-pagination-",
            currentClass: "popup__swiper-pagination-current",
            totalClass: "popup__swiper-pagination-total",
            hiddenClass: "popup__swiper-pagination-hidden",
            progressbarFillClass: "popup__swiper-pagination-progressbar-fill",
            progressbarOppositeClass:
              "popup__swiper-pagination-progressbar-opposite",
            clickableClass: "popup__swiper-pagination-clickable",
            lockClass: "popup__swiper-pagination-lock",
          },
        },
        create: function () {
          n.extend(this, {
      ...
      },
      {
        ...
        params: {
          zoom: {
            ...
            zoomedSlideClass: "popup__item-zoomed",
          },
        },
        create: function () {
          var e = this,
      ...
      },
      {
        ...
        params: {
          thumbs: {
            ...
            swiper: null,
            slideThumbActiveClass: "popup__item-thumb-active",
            thumbsContainerClass: "popup__swiper-container-thumbs",
          },
        },
        create: function () {
          n.extend(this, {
